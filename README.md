...
program. Any bare number is seconds — `45`, `90`, `0.5` — with no upper limit; otherwise it
is a duration like `45s`, `1m30s` or `1h`. The value is the whole tune, scripts included:
